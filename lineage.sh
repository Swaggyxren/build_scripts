...
#  Target: LineageOS 23.2 (Android 16 / BP4A)
...
├── ROM      : LineageOS 23.2 (Android 16 / BP4A)
├── BRANCH   : ${BRANCH}
├── TYPE     : userdebug
...
{
    echo "=== [1/5] Initializing LineageOS 23.2 Manifest & Resyncing ==="
    ...
    git clone https://github.com/naden01/android_vendor_sony_dolby --depth 1 vendor/sony/dolby 2>/dev/null || git clone https://github.com/naden01/android_vendor_sony/dolby --depth 1 vendor/sony/dolby 2>/dev/null || true
    ...
    lunch lineage_LH8n-bp4a-userdebug
